 ...
 */
final class ModularDataBuilder {
    ...
    /**
     * @param tableSpec table spec containing only relevant columns i.e. all features and the target column
    ...
    public Data build() {
        ...
        final Feature[] features =
            m_featureBuilders.stream().flatMap(b -> b.build().stream()).toArray(Feature[]::new);
        ...
        final Feature target = targets.iterator().next();
//        return new Data(features, target, new ConstantWeightContainer((int)m_table.size()));
        // TODO
        return null;
    }
